...
pid_t get_pid_from_proc_self ()
{
  ...
  //readlink ("/run/media/Technician/Work/Work/Newark/TBHS/Episodes/Episode_Files/Episode 189 - Raspberry Pi Compute Calculator/Software/Calculator/Keypad_Driver/Reference/Process_Control/get-pid", target, sizeof (target));
